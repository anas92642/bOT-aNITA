...
// Owner & Bot Details
global.owner = process.env.OWNER_NUMBER || "923074499097";
global.anitav4 = process.env.BOT_NAME || "Anas_Ishaq";
global.ownername = process.env.OWNER_NAME || "Anas_Ishaq";
global.packname = process.env.PACK_NAME || "Anas_Ishaq";
global.author = process.env.AUTHOR || "Anas_Ishaq";
global.channelname = process.env.CHANNEL_NAME || "Anas_Ishaq";
...
global.mess = {
    ...
    admin: process.env.MESSAGE_ADMIN || '_*❗This Command Can Only Be Used By Group Admins Anas_Ishaq !*_',
    botAdmin: process.env.MESSAGE_BOT_ADMIN || '_*❗This Command Can Only Be Used When Bot Becomes Group Admin Anas_Ishaq!*_',
    OnlyOwner: process.env.MESSAGE_OWNER || '_*❗This Command Can Only Be Used By My Owner Anas_Ishaq !*_',
    OnlyGrup: process.env.MESSAGE_GROUP || '_*❗This Command Can Only Be Used In Group Chat  Anas_Ishaq!*_',
    private: process.env.MESSAGE_PRIVATE || '_*❗This Command Can Only Be Used In Private Chat Anas_Ishaq !*_',
    wait: process.env.MESSAGE_WAIT || '_*Please Wait*_',
    notregist: process.env.MESSAGE_NOT_REGIST || '_*You are not registered in the Bot Database. Please register first Anas_Ishaq*_',
    premium: process.env.MESSAGE_PREMIUM || '_*Premium only" Want Premium? Chat Owner Anas_Ishaq*_',
